...
from survey_data import (A6000_MARKS, AFS_TYPE, AREA, CAMERA_MODEL,
                         CUSTOMER_COMPANY, FLIGHT_ALTITUDE, GROUND_PIXEL_SIZE,
                         OBJECT_NAME, PASSPORT_DIRECTORY,
                         RELIEF_ELEVATION_RANGE, RELIEF_TYPE, RINEX, RXI_MARKS,
                         SITE_NAME, TELEMETRY, TERRITORY_TYPE)
